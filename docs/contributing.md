...
Add entries to the English locale files in `public/locales/en/`:
...
This repository is maintained as an English-only build. Update `public/locales/en/` when you need to adjust shared UI or tool copy.
