/*
 * coherentpdf.global.d.ts - TypeScript type definitions for LocalPDFKit / CoherentPDF integration
 *
 * These type definitions are used by the LocalPDFKit project.
